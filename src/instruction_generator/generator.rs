...
type SIVTuple = (String, Instruction, Version);
pub fn instruction_template_list() -> Vec<Box<dyn FnMut([u32; 4]) -> SIVTuple>> {
    ...
    vec![
        ...
        reg_imm2(I::AddImmediatePC, "addiupc", (-0x40000, 0x3FFFF)),
        gen_four_arg::<RR, RR, RR, IR>(Version::R5, I::Align, "align", (), (), (), (0, 3)),
        ...
        reg_imm2(I::AlignedAuiPC, "aluipc", (0, 0xFFFF)),
        reg_imm3(I::AndImmediate, "andi", (0, 0xFFFFFFFF)),
        three_gpr(I::And, "and"),
        reg_imm3(I::AddUpperImmediate, "aui", (-0x8000, 0x7FFF)),
        reg_imm2(I::AddUpperImmediatePC, "auipc", (-0x8000, 0x7FFF)),
        one_label(
        ...
        one_label(I::BranchCompactLink, "balc", 26),
        one_label(
        ...
        gen_double_arg::<IR, SAR>(Version::R5, I::Cache, "cache", (0, 31), (-0x8000, 0x7FFF)),
        gen_double_arg::<IR, SAR>(Version::R6, I::Cache, "cache", (0, 31), (-0x100, 0xFF)),
        ...
        two_gpr(I::CountLeadingOne, "clo"),
        two_gpr(I::CountLeadingZero, "clz"),
        ...
        one_gpr(I::Ginvi, "ginvi"),
        gen_double_arg::<RR, IR>(Version::R5, I::Ginvt, "ginvt", (), (0, 3)),
        gen_four_arg::<RR, RR, IR, IR>(Version::R5, I::InsertBits, "ins", (), (), (1, 16), (1, 16)),
        gen_single_arg::<AlignedLabelRand>(Version::R5, I::Jump, "j", (0, (1 << 26) - 1)),
        gen_single_arg::<AlignedLabelRand>(Version::R5, I::JumpLink, "jal", (0, (1 << 26) - 1)),
        one_gpr(
        ...
        reg_sumaddr(I::LoadLinkedWord, "ll", 16),
        gen_triple_llwp::<RR, RR, RR>(Version::R5, I::LoadLinkedWordPaired, "llwp", (), (), ()),
        reg_sumaddr_r6(I::LoadLinkedWord, "ll", 9),
        ...
        reg_imm2(I::LoadUpperImmediate, "lui", (0, 0xFFFF)),
        gen_double_arg::<FR, IAR>(
            Version::R5,
        ...
        reg_sumaddr(I::LoadWordLeft, "lwl", 16),
        reg_sumaddr(I::LoadWordRight, "lwr", 16),
        reg_imm2(I::LoadWordPCRelative, "lwpc", (-0x40000, 0x3FFFF)),
        ...
        one_gpr(I::MoveFromHi, "mfhi"),
        one_gpr(I::MoveFromLo, "mflo"),
        ...
        one_gpr(I::MoveToHi, "mthi"),
        one_gpr(I::MoveToLo, "mtlo"),
        three_gpr(I::MulOld, "mul"),
        ...
        three_gpr(I::Nor, "nor"),
        three_gpr(I::Or, "or"),
        reg_imm3(I::OrImmediate, "ori", (0, 0xFFFFFFFF)),
        ...
        gen_double_arg::<IR, SAR>(Version::R5, I::Pref, "pref", (0, 31), (-0x8000, 0x7FFF)),
        gen_double_arg::<IR, SAR>(Version::R6, I::Pref, "pref", (0, 31), (-0x100, 0xFF)),
        gen_double_arg::<IR, IAR>(Version::R5, I::PrefIndexed, "prefx", (0, 31), ()),
        reg_imm3(I::ReadHWReg, "rdhwr", (0, 7)),
        two_gpr(I::ReadPGPR, "rdpgpr"),
        ...
        reg_imm3(I::RotateRight, "rotr", (0, 31)),
        three_gpr(I::RotateRightVariable, "rotrv"),
        ...
        reg_sumaddr(I::StoreConditional, "sc", 16),
        reg_sumaddr_r6(I::StoreConditional, "sc", 9),
        ...
        gen_single_arg::<IR>(Version::R5, I::SwDebugBreak, "sdbbp", (0, (1 << 20) - 1)),
        gen_double_arg::<FR, IAR>(
            Version::R5,
        ...
        reg_imm3(I::ShiftLeftLogical, "sll", (0, 31)),
        three_gpr(I::ShiftLeftLogicalVar, "sllv"),
        ...
        reg_imm3(I::ShiftRightArithmetic, "sra", (0, 31)),
        three_gpr(I::ShiftRightArithmeticVar, "srav"),
        reg_imm3(I::ShiftRightLogical, "srl", (0, 31)),
        three_gpr(I::ShiftRightLogicalVar, "srlv"),
        ...
        reg_sumaddr(I::StoreWordLeft, "swl", 16),
        reg_sumaddr(I::StoreWordRight, "swr", 16),
        ...
        gen_single_arg::<IR>(Version::R5, I::Sync, "sync", (0, 31)),
        gen_single_arg::<SAR>(
            Version::R5,
        ...
        no_args(&I::Wait, "wait"),
        two_gpr(I::WritePGPR, "wrpgpr"),
        two_gpr(I::WordSwapHalfwords, "wsbh"),
        three_gpr(I::Xor, "xor"),
        reg_imm3(I::XorImmediate, "xori", (0, 0xFFFFFFFF)),
    ]
}
