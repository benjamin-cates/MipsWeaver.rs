...
pub fn instruction_template_list() -> Vec<Box<dyn FnMut([u32; 4]) -> (String, Instruction, Version)>> {
    ...
    vec![
        ...
        // BranchCop for cop1
        imm_label(
            |a| I::BranchCop(Cop1, false, NL, a),
            "bc1f",
            (0, 7),
            16,
        ),
        one_label(
            |a| I::BranchCop(Cop1, false, NL, (Imm(0), a)),
            "bc1f",
            16,
        ),
        imm_label(
            |a| I::BranchCop(Cop1, false, YL, a),
            "bc1fl",
            (0, 7),
            16,
        ),
        one_label(
            |a| I::BranchCop(Cop1, false, YL, (Imm(0), a)),
            "bc1fl",
            16,
        ),
        imm_label(
            |a| I::BranchCop(Cop1, true, NL, a),
            "bc1t",
            (0, 7),
            16,
        ),
        one_label(
            |a| I::BranchCop(Cop1, true, NL, (Imm(0), a)),
            "bc1t",
            16,
        ),
        imm_label(
            |a| I::BranchCop(Cop1, true, YL, a),
            "bc1tl",
            (0, 7),
            16,
        ),
        one_label(
            |a| I::BranchCop(Cop1, true, YL, (Imm(0), a)),
            "bc1tl",
            16,
        ),
        // BranchCop for cop2
        imm_label(
            |a| I::BranchCop(Cop2, false, NL, a),
            "bc2f",
            (0, 7),
            16,
        ),
        one_label(
            |a| I::BranchCop(Cop2, false, NL, (Imm(0), a)),
            "bc2f",
            16,
        ),
        imm_label(
            |a| I::BranchCop(Cop2, false, YL, a),
            "bc2fl",
            (0, 7),
            16,
        ),
        one_label(
            |a| I::BranchCop(Cop2, false, YL, (Imm(0), a)),
            "bc2fl",
            16,
        ),
        imm_label(
            |a| I::BranchCop(Cop2, true, NL, a),
            "bc2t",
            (0, 7),
            16,
        ),
        one_label(
            |a| I::BranchCop(Cop2, true, NL, (Imm(0), a)),
            "bc2t",
            16,
        ),
        imm_label(
            |a| I::BranchCop(Cop2, true, YL, a),
            "bc2tl",
            (0, 7),
            16,
        ),
        one_label(
            |a| I::BranchCop(Cop2, true, YL, (Imm(0), a)),
            "bc2tl",
            16,
        ),
        ...
        reg_sumaddr(|a| I::LoadCop(Cop2, Doubleword, a), "ldc2", 16),
        reg_sumaddr_r6(|a| I::LoadCop(Cop2, Doubleword, a), "ldc2", 11),
        ...
        reg_sumaddr(|a| I::LoadCop(Cop2, Word, a), "lwc2", 16),
        reg_sumaddr_r6(|a| I::LoadCop(Cop2, Word, a), "lwc2", 11),
        ...
        two_gpr(
            |a| I::MoveFromCop(Cop0, (a.0, a.1, Immediate(0))),
            "mfc0",
        ),
        ...
        two_gpr(
            |a| I::MoveToCop(Cop0, (a.0, a.1, Immediate(0))),
            "mtc0",
        ),
        ...
        two_gpr(
            |a| I::MoveToHiCop(Cop0, (a.0, a.1, Immediate(0))),
            "mthc0",
        ),
        ...
        reg_sumaddr(|a| I::StoreCop(Cop2, Doubleword, a), "sdc2", 16),
        reg_sumaddr_r6(|a| I::StoreCop(Cop2, Doubleword, a), "sdc2", 11),
        ...
        reg_sumaddr(|a| I::StoreCop(Cop2, Word, a), "swc2", 16),
        reg_sumaddr_r6(|a| I::StoreCop(Cop2, Word, a), "swc2", 11),
