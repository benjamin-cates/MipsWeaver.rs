...
fn inst_type_helper(inst: &Instruction, config: &Config) -> InstructionType {
    ...
    match inst {
        ...
        I::Addiupc((_, imm)) => n.cap_imm(imm, 19).min_v(v, R6),
        I::Addi(S, (_, _, imm)) => n.pseudo_imm(&S, imm, 16).max_v(v, R5),
        I::Addi(U, (_, _, imm)) => n.pseudo_imm(&S, imm, 16),
        I::Align(_) => n.min_v(v, R6),
        I::AlignVariableFloat(_) => n.min_v(v, R2).max_v(v, R5),
        I::AlignedAuiPC(_) => n.min_v(v, R6),
        I::And(_) => n,
        I::Andi((_, _, imm)) => n.pseudo_imm(&U, imm, 16),
        I::Aui((_, _, _)) => n.min_v(v, R6),
        I::AuiPC((_, _)) => n.min_v(v, R6),
        ...
        I::DivFloat(_, _) => n,
        I::Dvp(_) => n.min_v(v, R6),
        I::Ehb => n.min_v(v, R2),
        I::EI(_) => n.min_v(v, R2),
        I::Eret(true) => n,
        I::Eret(false) => n.min_v(v, R5),
        I::Evp(_) => n.min_v(v, R6),
        I::Ext(_) => n.min_v(v, R2),
        I::Floor(it, _, _) => n.lf_it(v, it),
        I::Ginvi(_) => n.min_v(v, R6),
        I::Ginvt(_) => n.min_v(v, R6),
        I::Ins(_) => n.min_v(v, R2),
        I::Jump(_) => n,
        I::JumpLink(..) => n,
        ...
        I::Nor(_) => n,
        I::Or(_) => n,
        I::Ori((_, _, imm)) => n.pseudo_imm(&U, imm, 16),
        ...
        I::Sync(_) => n,
        I::Synci(addr) => n.base_offset(&addr, 16).min_v(v, R2),
        I::Syscall(_) => n,
        I::Trap(_, _, _) => n,
